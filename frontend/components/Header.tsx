  ...
  return (
    <header className="bg-hack-bg border-b border-hack-border sticky top-0 z-50 backdrop-blur-md bg-hack-bg/90">
      <div className="max-w-7xl mx-auto">
        <div className="flex">
          {/* Left sidebar */}
          <div className="w-72 px-6 py-6 border-r border-hack-border">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h1 className="text-2xl font-bold text-hack-text font-mono">
                      Hack<span className="text-hack-primary">Club</span>
                    </h1>
                    <p className="text-sm text-hack-textSecondary font-mono">#channel</p>
                  </div>
                </div>
              </div>
          ...
          <div className="flex-1">
            <div className="px-6 py-4 border-b border-hack-border bg-hack-surface/50">
